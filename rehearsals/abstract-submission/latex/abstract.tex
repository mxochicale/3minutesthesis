...
For example, in the last decade, experimental robots, mainly Japanese ones, 
...
in order to automatically measure human movement and emotions \cite{xochicale2018}.
